...
declare module "stripe" {
    namespace Stripe {
        ...
        interface ChargeEvent extends BaseEvent {
            type: "charge.captured" | "charge.expired" | "charge.failed" | "charge.pending" | "charge.refunded" | "charge.succeeded" | "charge.updated"
        ...
        interface PaymentMethodEvent extends BaseEvent {
            type: "payment_method.attached" | "payment_method.card_automatically_updated" | "payment_method.detached" | "payment_method.updated"
            data: DiscriminatedEvent.Data<Stripe.PaymentMethod>
        }

        interface PayoutEvent extends BaseEvent {
            type: "payout.canceled" | "payout.created" | "payout.failed" | "payout.paid" | "payout.updated"
        ...
        interface ReportRunEvent extends BaseEvent {
            type: "reporting.report_run.failed" | "reporting.report_run.succeeded" | "reporting.report_type.updated"
        ...
        interface SetupIntentEvent extends BaseEvent {
            type: "setup_intent.canceled" | "setup_intent.created" | "setup_intent.setup_failed" | "setup_intent.succeeded"
        ...
        interface SourceEvent extends BaseEvent {
            type: "source.canceled" | "source.chargeable" | "source.failed" | "source.mandate_notification" | "source.refund_attributes_required"
            data: DiscriminatedEvent.Data<Stripe.Source>
        }
